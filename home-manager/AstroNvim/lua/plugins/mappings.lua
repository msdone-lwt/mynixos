...
return {
  {
    ...
    opts = {
      mappings = {
        ...
        i = {
          ["<C-h>"] = { "<Esc><cmd>lua require('smart-splits').move_cursor_left()<CR>", desc = "Normal mode & move left" },
          ["<C-j>"] = { "<Esc><cmd>lua require('smart-splits').move_cursor_down()<CR>", desc = "Normal mode & move down" },
          ["<C-k>"] = { "<Esc><cmd>lua require('smart-splits').move_cursor_up()<CR>", desc = "Normal mode & move up" },
          ["<C-l>"] = { "<Esc><cmd>lua require('smart-splits').move_cursor_right()<CR>", desc = "Normal mode & move right" },
          ["<M-,>"] = { "<Esc><cmd>lua require('smart-splits').resize_left()<cr>", desc = "Resize split left" },
          ["<M-.>"] = { "<Esc><cmd>lua require('smart-splits').resize_right()<cr>", desc = "Resize split right" },
          ["<M-<>"] = { "<Esc><cmd>lua require('smart-splits').resize_up()<cr>", desc = "Resize split up" },
          ["<M->>"] = { "<Esc><cmd>lua require('smart-splits').resize_down()<cr>", desc = "Resize split down" },
          ["<C-v>"] = { "<C-[>pa", desc = "paste" },
          -- augment
